...
import vizdoomgym
from src.env_utils import ActionActedWrapper, Minigrid2Image, NoisyBackgroundWrapper, Environment, PlayGround2
...
if "MiniGrid" in args.env:
    ...
    env = ActionActedWrapper(Minigrid2Image(PlayGround2()))
    env = Environment(env)
else:
